...
public class RevolverShooting : NetworkBehaviour
{
    ...
    private void RPCShoot()
    {
        ...
        muzzle.Play(); Invoke("StopParticles", 0.2f);
        NowMaxMag--;recoilObj.Fire(); ShowAmmo();
        animatorIK.Play("FireRevolver"); animator2.Play("Fire");
